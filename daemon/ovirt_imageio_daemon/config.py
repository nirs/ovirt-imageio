...
class images:
    ...
    # Maximum number of connections for same /image/ticket-id URL. Using
    # more connections may improve single image upload or donwload, but
    # may decrease throughput when transferring multiple images
    # concurrently.
    #
    # Some backends do not support more than 8 connections, regardless
    # of this value set here. Some backends limit the number of writers
    # regardless of the value set here.
    #
    # To disable multiple connections set the value to 1. This will
    # ensure single reader or writer for upload and downloads.
    max_connections = 8
